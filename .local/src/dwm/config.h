...
static const char *colors[][3]      = {
	...
	[SchemeWarn]  = { col_orange, col_gray1,  col_cyan  },
	[SchemeUrgent]  = { col_urgent, col_gray1,  col_cyan  },
...
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-g", "120x20", "-e", "ncmpcppdd", NULL };
