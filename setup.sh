...
# Bloat Software 5
pacman --noconfirm -S streamlink adobe-source-han-sans-jp-fonts playerctl i3-gaps pacman --noconfirm -S lightdm lightdm-webkit2-greeter || { echo 'failed at installing packages from official repo' ; exit 1; }
# Bloat Software 6
pacman --noconfirm -S unclutter || { echo 'failed at installing packages from official repo' ; exit 1; }
# Systemd software ?!
